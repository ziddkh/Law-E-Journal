        ...
        <div class="card-body">
            <form method="POST" action="{{ route('profiles.update', $profile->id) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="phone" class="form-control @error('phone') is-invalid @enderror" id="phone" name="phone" value="{{ old('phone', $profile->phone) }}">
                    @error('phone')
                        <span class="invalid-feedback" role="alert">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="instagram" class="form-control @error('instagram') is-invalid @enderror" id="instagram" name="instagram" value="{{ old('instagram', $profile->instagram) }}">
                    @error('instagram')
                        <span class="invalid-feedback" role="alert">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="facebook" class="form-control @error('facebook') is-invalid @enderror" id="facebook" name="facebook" value="{{ old('facebook', $profile->facebook) }}">
                    @error('facebook')
                        <span class="invalid-feedback" role="alert">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="twitter" class="form-control @error('twitter') is-invalid @enderror" id="twitter" name="twitter" value="{{ old('twitter', $profile->twitter) }}">
                    @error('twitter')
                        <span class="invalid-feedback" role="alert">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="tik_tok" class="form-control @error('tik_tok') is-invalid @enderror" id="tik_tok" name="tik_tok" value="{{ old('tik_tok', $profile->tik_tok) }}">
                    @error('tik_tok')
                        <span class="invalid-feedback" role="alert">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="youtube" class="form-control @error('youtube') is-invalid @enderror" id="youtube" name="youtube" value="{{ old('youtube', $profile->youtube) }}">
                    @error('youtube')
                        <span class="invalid-feedback" role="alert">{{ $message }}</span>
                    @enderror
                </div>
