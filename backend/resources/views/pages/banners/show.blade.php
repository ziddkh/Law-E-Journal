        ...
        <div class="card-body">
            <form method="POST" action="{{ route('banners.update', $banner->id) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('cta_button_text') is-invalid @enderror" id="cta_button_text" name="cta_button_text" value="{{ old('cta_button_text', $banner->cta_button_text) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input type="url" class="form-control @error('cta_button_url') is-invalid @enderror" id="cta_button_url" name="cta_button_url" value="{{ old('cta_button_url', $banner->cta_button_url) }}" required>
